                            ...
                            <div class="col-xl-12 col-md-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fas fa-table mr-5"></i> <strong>Lista de Funcionários</strong>
||||||| .r81
...
<<<<<<< .mine
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                        <form role="form" id="form-user-create" data-toggle="validator">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <label for="exampleInputName">Nome</label>
                                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Digite o nome do usuário" name="name" required>
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputBirth">Nascimento</label>
                                                    <input type="date" class="form-control" id="exampleInputBirth" name="birth" required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="1xampleInputEmail" placeholder="Digite o e-mail" name="email"required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Senha</label>
                                                    <input type="password" class="form-control" id="exampleInputPassword" placeholder="Crie uma senha" name="password"required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                                <br><br>
                                                <div class="form-group">
