                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-md-4">
                                <div class="box box-success">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form role="form" data-toggle="validator" id="form-user-create" method="post">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="Cargo" name="cargo">
                                                    <option value="Western Sahara">Operacional</option>
                                                    <option value="Western Sahara">Gerente</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="emailFunc">E-mail</label>
                                                <input type="email" class="form-control" id="emailFunc" placeholder="Digite o e-mail" name="email">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="SenhaFunc">Senha</label>
                                                <input type="password" class="form-control" id="SenhaFunc" placeholder="Crie uma senha" name="password">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <br><br>
                                            <div class="form-group">
