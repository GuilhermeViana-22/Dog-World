...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Out-2020 às 19:32
...
(15, 'dcqw', 'dq', '123', 'wqcdq', 'Coelho', 'M', 'MATA', 'S', 12);
...
(1, 1, 1, 6, ' max', '2020-10-29', 50, '23', '13:00:00', ''),
(4, 1, 1, 6, ' max', '2020-10-31', 50, '23', '12:00:00', ''),
(5, 1, 2, 6, '', '2020-10-28', 6, '24', '13:30:00', ''),
(6, 1, 0, 1, ' teste', '0000-00-00', 0, 'Selecione', '12:00:00', ''),
(14, 6, 2, 4, '', '2020-10-30', 0, 'Selecione', '12:00:00', '');
...
(13, 'luiz', '123.123.123-12', '65.465.143-2', 'M', '(12) 3123-1231', '2020-10-20', 'dd@dd.com', '05568000', 'Rua Antônio Francisco Soares', 'casa', 'São Paulo', 'SP', 'Administrativo', 12.312, '34:53:45', '2020-10-01', 'S', '123'),
(14, 'cedr', '654.654.654-65', '65.564.651-6', 'M', '(66) 5062-0620', '2024-10-15', 'aa@aa.com', '05568000', 'Rua Antônio Francisco Soares', 'casa', 'São Paulo', 'SP', 'Estoquista', 1.789, '99:99:99', '2020-10-24', 'S', '12');
...
CREATE TABLE `produto` (
  ...
  `cod_fornecedor` int(100) DEFAULT NULL,
  `ativo` char(1) NOT NULL,
...
INSERT INTO `produto` (`cod_produto`, `titulo`, `quantidade`, `cod_lote`, `valor_unitario`, `cod_fornecedor`, `ativo`, `categoria`) VALUES
(1, 'golden gatos castrados sabor frango', 7, 1, 30.4, 1, 'S', 'Prateleira'),
(3, 'Premier urinary 30kg', 10, 12, 90, 2, 'S', 'Prateleira'),
(4, 'Ração Premier Gatos Adultos Castrado Ambientes Internos 7,5kg ', 10, 3, 149, 2, 'S', 'Prateleira'),
(5, 'Golden cachorros castrados sabor frango 30kg', 15, 2, 30, 1, 'N', 'Prateleira'),
(7, 'Golden cachorros castrados sabor carne 30kg', 10, 21, 30, 1, 'S', 'Prateleira'),
(8, 'Ração Nutrópica para Periquito', 15, 11, 4.5, 4, 'S', 'Prateleira'),
(9, 'Golden Para Filhotes', 1, 1234, 12, 1, 'N', 'Prateleira'),
(10, 'Golden Para Gatos', 12, 12345, 18.7, 2, 'S', 'Prateleira'),
(14, 'bolinha de borracha', 5, 15, 5, 5, 'S', 'Prateleira'),
(15, 'bolinha de borracha', 5, 15, 5, 1, 'N', 'Prateleira'),
(23, 'Banho', 0, 0, 20, NULL, 's', 'Serviços'),
(24, 'Tosa', NULL, NULL, 15.5, NULL, 's', 'Serviços'),
(25, 'Banho e Tosa', NULL, NULL, 35, NULL, 's', 'Serviços');
...
INSERT INTO `vendas` (`cod_venda`, `cod_funcionario`, `cod_cliente`, `cod_servico`, `cpf_cliente`, `nome_cliente`, `valor_total`, `forma_pagamento`, `data_venda`, `horario`, `status_venda`) VALUES
(65, 1, NULL, NULL, '12', 'w', 12, 'Crédito', '2020-10-25', '02:39:56', 1),
(72, 6, NULL, NULL, '', '', 0, 'Crédito', '2020-10-25', '10:46:48', 1),
(74, 6, NULL, NULL, '213', 'GUI', 25, 'Débito', '2020-10-25', '11:05:58', 1),
(79, 6, NULL, NULL, '5453545', 'teste', 14, '', '2020-10-25', '11:27:39', 2),
(80, 6, NULL, NULL, '32424324', 'eeee', 0, 'Crédito', '2020-10-25', '11:59:22', 2),
(81, 6, NULL, NULL, '', '', 0, 'Débito', '2020-10-25', '12:40:06', 1);
...
--
ALTER TABLE `animal`
  MODIFY `id_animal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de tabela `atendimento`
--
ALTER TABLE `atendimento`
  MODIFY `cod_servico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `produto`
  MODIFY `cod_produto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de tabela `produtos_venda`
--
ALTER TABLE `produtos_venda`
  MODIFY `cod_prod_venda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT de tabela `vendas`
--
ALTER TABLE `vendas`
  MODIFY `cod_venda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
