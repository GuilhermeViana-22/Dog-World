                                        ...
                                        <input type="submit" value="Submit">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input style="margin-left: 20px;" type="date" class="form-control" value=" <?php if (isset($_GET["cod_servico"])) {
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input style="width: 200px;" class="form-control" value=" <?php if (isset($_GET["cod_servico"])) {
                                                                                                                    echo $dados["valor"];
                            ...
                            <div class="card-body mr-2">
                                <table class="table table-bordered">
                                    ...
                                    if (isset($_GET["pesquisa"])) {
                                        ...
                                        $consultaTabela = "SELECT * FROM atendimento WHERE nome LIKE '%$pesquisa%'";
                                    } else {
